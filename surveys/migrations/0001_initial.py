    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question_type', models.CharField(choices=[('text', 'Text'), ('textarea', 'Textarea'), ('rating', 'Rating'), ('yesno', 'Yes/No'), ('dropdown', 'Dropdown'), ('checkbox', 'Checkbox'), ('radio', 'Radio'), ('date', 'Date')], max_length=20)),
